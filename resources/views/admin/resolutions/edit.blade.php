...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.resolution.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.resolutions.update", [$resolution->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
