...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.root_cause.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.root_causes.update", [$root_cause->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
